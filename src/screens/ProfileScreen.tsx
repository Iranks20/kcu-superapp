...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#315B0E', paddingTop: 48, paddingHorizontal: 16, paddingBottom: 24 },
  ...
  avatarText: { color: '#315B0E', fontSize: 24, fontWeight: 'bold' },
  ...
  statValue: { color: '#315B0E', fontSize: 20, fontWeight: 'bold' },
